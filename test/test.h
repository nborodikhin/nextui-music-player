...
// Signed-int equality with value diagnostics. Prefer this over CHECK_EQ_SZ for
// anything that can legitimately be negative - a failed `selected == -1` prints
// as 18446744073709551615 when it goes through size_t.
